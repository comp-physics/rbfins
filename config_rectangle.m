function config = config_rectangle()
% CONFIG_RECTANGLE - Configuration parameters for rectangle flow simulation
%
% This function returns a structure containing all configuration parameters
% for the rectangle flow simulation.
%
% Usage: cfg = config_rectangle();
...
config.mesh.dist = 0.05;                  % Mesh spacing (finer for rectangle)
...
%% Geometry Parameters
config.geometry.type = 'rectangle';      % Geometry type
