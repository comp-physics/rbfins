...
%% Load numerical scheme coefficients from config
cfg = config();
ADAMS_BASHFORTH_COEFF_CURRENT = cfg.schemes.adams_bashforth_current;
ADAMS_BASHFORTH_COEFF_PREVIOUS = cfg.schemes.adams_bashforth_previous;
CRANK_NICOLSON_COEFF = cfg.schemes.crank_nicolson;
...
% 
U2   =  U1 + dt*nu*(L0*U)*CRANK_NICOLSON_COEFF;

V2   =  V1 + dt*nu*(L0*V)*CRANK_NICOLSON_COEFF;
