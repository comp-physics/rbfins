function config = config_cylinder()
% CONFIG_CYLINDER - Configuration parameters for cylinder flow simulation
%
% This function returns a structure containing all configuration parameters
% for the cylinder flow simulation. This is the original geometry configuration.
%
% Usage: cfg = config_cylinder();
...
%% Geometry Parameters
config.geometry.type = 'cylinder';       % Geometry type
