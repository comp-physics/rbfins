classdef BaseGeometryTest < matlab.unittest.TestCase
    ...
    properties (Abstract, Constant)
        ...
        CONFIG_FUNCTION   % e.g., 'config_cylinder', 'config_ellipse', 'config_rectangle'
    ...
    methods (Test)
        function smokeRun(testCase)
            ...
            try
                ...
                evalin('base', sprintf('try; setenv(''CONFIG_FUNC'', ''%s''); simulate; success = true; catch ME; errorMsg = ME.message; end;', ...
                    testCase.CONFIG_FUNCTION));
        ...
        function testConfig(testCase)
            ...
            try
                ...
                cfg = feval(testCase.CONFIG_FUNCTION);
                testCase.verifyTrue(isstruct(cfg), sprintf('%s() should return a structure', ...
                    testCase.CONFIG_FUNCTION));
        ...
        function testMatchesGolden(testCase)
            ...
            try
                ...
                success = evalin('base', 'success');
                testCase.verifyTrue(logical(success), sprintf('Current %s simulation should complete without errors', ...
                    testCase.GEOMETRY_TYPE));
