function G = make_rectangle_geometry(cfg)
    ...
    fd1 = @(p) min(a1 + b1 * abs(drounded_rectangle(p, rect_x_center, rect_y_center, ...
                                                    rect_width, rect_height, corner_radius)), ...
    ...
    for i = 1:size(boundary_obs_s, 1)
        ...
        delta = eps * 100;
        dx = (drounded_rectangle([x_pt + delta, y_pt], rect_x_center, rect_y_center, ...
                                 rect_width, rect_height, corner_radius) - ...
              drounded_rectangle([x_pt - delta, y_pt], rect_x_center, rect_y_center, ...
                                 rect_width, rect_height, corner_radius)) / (2 * delta);
        dy = (drounded_rectangle([x_pt, y_pt + delta], rect_x_center, rect_y_center, ...
                                 rect_width, rect_height, corner_radius) - ...
              drounded_rectangle([x_pt, y_pt - delta], rect_x_center, rect_y_center, ...
                                 rect_width, rect_height, corner_radius)) / (2 * delta);
